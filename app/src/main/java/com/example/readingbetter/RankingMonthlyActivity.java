...
public class RankingMonthlyActivity extends Activity {
    public String monthlyRanking;   // 한 달 랭킹을 불러오는 서버 링크를 저장할 String 변수
    public String myMonthlyRanking;   // 나의 한 달 랭킹을 불러오는 서버 링크를 저장할 String 변수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rankingmonthly_page);

        userNo = LoginActivity.setting.getLong("no",0);
        System.out.println("no = "+userNo);

        // ranking.php를 GetConnect로 연결
        monthlyRanking = "http://220.67.115.225:8088/readingbetter/rankapp/monthlyrank";
        myMonthlyRanking = "http://220.67.115.225:8088/readingbetter/rankapp/mymonthlyrank?memberNo="+userNo;

        GetConnect totalTask = new GetConnect(monthlyRanking);
        GetConnect myTotalTask = new GetConnect(myMonthlyRanking);
